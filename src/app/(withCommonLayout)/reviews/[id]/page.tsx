			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
				<div className="lg:col-span-2 space-y-6">
					<div className="space-y-4">
						<div className="h-6 light:bg-muted rounded w-24"></div>
						<div className="h-10 light:bg-muted rounded w-3/4"></div>
						<div className="flex items-center gap-2">
							<div className="h-8 w-8 light:bg-muted rounded-full"></div>
							<div className="h-5 light:bg-muted rounded w-32"></div>
						</div>
						<div className="h-5 light:bg-muted rounded w-40"></div>
					</div>
					<div className="aspect-video light:bg-muted rounded-lg"></div>
					<div className="space-y-4">
						<div className="h-4 light:bg-muted rounded w-full"></div>
						<div className="h-4 light:bg-muted rounded w-full"></div>
						<div className="h-4 light:bg-muted rounded w-3/4"></div>
					</div>
				</div>
				<div className="space-y-6">
					<div className="h-64 light:bg-muted rounded-lg"></div>
					<div className="h-64 light:bg-muted rounded-lg"></div>
				</div>
			</div>
		</div>
		...
		<Suspense fallback={<ReviewDetailSkeleton />}>
			<div className="container mx-auto py-6 px-4 md:px-6 max-w-7xl">
				...
				{isPremiumUnlocked && review.isPremium && (
					<Alert className="mb-6 light:bg-green-50 border-green-200 dark:bg-green-950 dark:border-green-900">
						<CheckCircle2 className="h-5 w-5 text-green-600 dark:text-green-400" />
						<AlertTitle className="text-green-800 dark:text-green-300">Premium Content Unlocked</AlertTitle>
						<AlertDescription className="text-green-700 dark:text-green-400">
							You have successfully unlocked this premium review. Transaction ID:{' '}
						...
						<div className="space-y-6">
							...
							{premiumContent && isPremiumUnlocked && (
								<div className="relative">
									<div className="absolute inset-0 w-1 light:bg-primary rounded-full -left-4 hidden md:block" />
									<div className="bg-primary/5 border border-primary/10 rounded-lg p-6 relative">
										<Badge className="absolute -top-3 left-4 light:bg-primary text-primary-foreground">
											Premium Content
										</Badge>
								...
								<div className="bg-muted/30 border rounded-lg p-6 relative">
									...
									<div className="text-center py-6">
										...
										<p className="text-muted-foreground mb-4">
											Unlock this premium review to access exclusive insights and detailed
											comparisons.
										</p>
										...
										<div key={relatedReview.id} className="flex gap-3">
											<div className="relative w-16 h-16 rounded-md overflow-hidden flex-shrink-0">
												...
												{relatedReview.isPremium && (
													<div className="absolute top-0 right-0 light:bg-primary text-[10px] text-primary-foreground px-1 py-0.5 rounded-bl-md">
														PRO
													</div>
												)}
											</div>
