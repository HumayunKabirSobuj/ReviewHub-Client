    ...
    <div className="relative w-full min-h-screen  overflow-hidden ">
      ...
      <section className="w-full light:bg-accent ">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-8 md:py-24">
          {/* Tagline */}
          <p className="light:light:text-black mb-4 md:mb-6">
      ...
      <section className="container mx-auto light:light:bg-white px-4 md:px-8 lg:px-16 py-8 md:py-12">
        ...
        <div className="container mx-auto px-4 py-16 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="light:light:bg-white p-6 rounded-lg shadow-sm border border-purple-200 hover:border-primary hover:shadow-md transition-all">
              ...
              <h3 className="font-bold text-lg mb-2 light:text-black">
                Product Reviews
              </h3>
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mt-8">
            ...
            <h2 className="text-2xl font-bold mb-8 light:text-black">
                ...
                >
                  ...
                  <AccordionContent className="px-4 pb-4 pt-0">
                    <p className="light:text-black text-sm">
                      ...
                      downvoting suggests it wasn't useful. Reviews with more
                ...
                >
                  ...
                  <AccordionContent className="px-4 pb-4 pt-0">
                    <p className="light:text-black text-sm">
                      ...
                      are typically filled internally. If you're interested in
