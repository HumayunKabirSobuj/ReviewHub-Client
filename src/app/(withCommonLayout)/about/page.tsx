...
export default function AboutPage() {
  return (
    <div className="relative w-full min-h-screen light:bg-white overflow-hidden px-4 md:px-8 lg:px-16 py-8 md:py-12">
      ...
      <div className="max-w-7xl mx-auto mt-16 md:mt-24">
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
          ...
          <div className="w-full md:w-3/5 space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold light:text-black">
              Our Mission
            </h2>
      ...
      {/* Our Story section */}
      <div className="max-w-7xl mx-auto mt-16 md:mt-24">
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center light:text-black">
          Our Story
        </h2>
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h3 className="font-bold text-lg mt-2 light:text-black">
                The Beginning
              </h3>
            </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 md:mt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="light:bg-white rounded-lg overflow-hidden shadow-sm border border-purple-200 hover:border-purple-600 hover:shadow-md transition-all">
            ...
            <div className="p-4">
              <h3 className="font-bold text-lg light:text-black">
                Sarah Johnson
              </h3>
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-xl light:text-black">
                    25+ Countries
                  </p>
                  <p className="light:text-black text-sm">
