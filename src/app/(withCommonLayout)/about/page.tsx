...
export default function AboutPage() {
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden px-4 md:px-8 lg:px-16 py-8 md:py-12">
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h3 className="font-bold text-lg mt-2">The Beginning</h3>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h3 className="font-bold text-lg mt-2">Growing Community</h3>
            </div>
            <div className="md:w-3/4 bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-600">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h3 className="font-bold text-lg mt-2">Premium Reviews</h3>
            </div>
            <div className="md:w-3/4 bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-600">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h3 className="font-bold text-lg mt-2">Global Impact</h3>
            </div>
            <div className="md:w-3/4 bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-600">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-xl">25+ Countries</p>
                  <p className="text-gray-500 text-sm">Active user presence</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-xl">3 Offices</p>
                  <p className="text-gray-500 text-sm">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-xl">50+ Team Members</p>
                  <p className="text-gray-500 text-sm">
      ...
      {/* CTA section */}
      <div className="max-w-7xl mx-auto mt-16 md:mt-24 mb-8">
