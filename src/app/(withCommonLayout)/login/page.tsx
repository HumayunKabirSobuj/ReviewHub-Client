...
export default function Home() {
	return (
		<main className="flex min-h-screen flex-col light:bg-gray-50 md:flex-row">
			{/* Illustration section - full width on mobile, half width on larger screens */}
			<div className="flex flex-1 flex-col items-center justify-center light:bg-blue-50 p-6 md:p-8 lg:w-1/2">
