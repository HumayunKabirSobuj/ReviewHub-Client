...
//   return (
//     <div>
//       <div className="flex min-h-screen light:bg-gray-50  overflow-y-hidden">
...
//         <div
//           className={cn(
//             "fixed inset-y-0 left-0 z-50 w-64 transform light:bg-white h-screen transition-transform duration-200 ease-in-out md:translate-x-0 md:static md:z-0",
	...
	return (
		<div>
			<div className="flex min-h-screen light:bg-gray-50 overflow-y-hidden">
											...
											<Link
												...
												className={`flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium ${
													isActive
														...
														: 'text-gray-600 dark:hover:bg-purple-500 dark:hover:text-white hover:bg-gray-100'
												}`}
												onClick={() => isMobile && setSidebarOpen(false)}
											>
												<item.icon className="h-4 w-4" />
				...
				<div className="flex-1 flex flex-col min-w-0 max-h-screen overflow-y-auto">
					<header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b light:bg-white px-4 md:px-6">
