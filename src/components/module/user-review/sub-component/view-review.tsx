...
export default function ViewReviewComponent({ review }: { review: reviewDtlType }) {
	return (
		<Card className="w-full border-none">
			<CardContent>
				...
				<div className="space-y-1 mb-4 flex ">
					...
					<p className="text-gray-500 w-[calc(100%-130px)]">{review.purchaseSource}</p>
				</div>
				<div className="mb-4 flex ">
					<label htmlFor="" className="w-[130px]">
						Category
					</label>
					<p className="text-gray-500 w-[calc(100%-130px)]">{review.category.name}</p>
				</div>
				...
				<div className="space-y-1 mb-4 flex">
					...
					<p className="text-gray-500 w-[calc(100%-130px)]">{review.price} BDT</p>
				</div>
			</CardContent>
		</Card>
	);
