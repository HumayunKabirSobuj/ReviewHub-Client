...
import {
  ...
  reviewDtlOne,
  reviewDtlType,
} from "@/components/types/add-review";
import {
  createUserReview,
  getAllCategories,
  updateUserReview,
} from "@/services/UserDashboard/ReviewServices";
          ...
          <Card className="w-full ">
            <CardHeader className="space-y-2">
              <div className="w-full">
                <CardTitle>
                  {" "}
                  {review === null ? "Write" : "Edit"} a review
                </CardTitle>
                <CardDescription>
                  Share your experience and help others to make informed
                  decisions
                </CardDescription>
              </div>
            </CardHeader>
