              ...
              <div className="mx-auto w-full max-w-2xl">
                <DrawerHeader>
                  <div className="flex justify-between">
                    <DrawerTitle>
                      {mode === 'view' ? 'View' : 'Edit'} Review Detail{' '}
                    </DrawerTitle>
                    <DrawerClose>
                      <CircleX />
                    </DrawerClose>
                ...
                <div className="pt-4 pb-0">
                  <div className="">
                    {mode === 'view' && (
                      <ViewReviewComponent review={reviewDtl} />
                    )}
                    {mode === 'edit' && (
                      <CreateReviewComponent review={reviewDtl} mode="edit" />
                    )}
                  </div>
                </div>
              </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="light:bg-white divide-y divide-gray-200">
                  {reviews.map((review, index) => (
                    <tr
                      key={index}
                      className={`hover:light:bg-gray-50 ${
