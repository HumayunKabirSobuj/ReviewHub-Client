...
export function ReviewForm({ initialData, isEditing = false }: ReviewFormProps) {
	...
	const completedFields = requiredFields.filter((field) => formValues[field as keyof ReviewFormValues]);
			...
			<CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-lg pb-4">
				<div className="flex justify-between items-center">
					...
					<div className="hidden md:block">
						<div className="light:bg-white rounded-full p-1 shadow-sm">
							<div className="flex items-center gap-2">
								<div className="relative w-24 h-3 light:bg-gray-200 rounded-full overflow-hidden">
									<div
										className="absolute top-0 left-0 h-full light:bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full"
					...
					<Form {...form}>
						<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<div className="light:bg-gray-50 p-4 rounded-lg border border-gray-100">
							...
							<TabsContent value="media" className="space-y-6 mt-0">
								<div className="light:bg-gray-50 p-6 rounded-lg border border-dashed border-gray-300">
									<div className="text-center">
										...
										<div className="flex justify-center mb-4">
											<label className="cursor-pointer">
												<div className="light:bg-white border border-gray-300 rounded-md px-4 py-2 hover:light:bg-gray-50 transition flex items-center gap-2">
										...
										{imagePreview && (
											<div className="mt-4">
												<div className="relative w-32 h-32 mx-auto">
													...
													<button
														type="button"
														className="absolute -top-2 -right-2 light:bg-red-500 text-white rounded-full p-1 shadow-sm hover:bg-red-600"
								...
								<div className="light:bg-blue-50 p-4 rounded-lg border border-blue-100 flex items-start gap-3">
									...
									<div>
										...
										<p className="text-xs text-blue-600 mt-1">
											Please ensure your review is honest, respectful, and helpful. Avoid
											including personal information or offensive language. Reviews that don't
											meet our guidelines may not be published.
										</p>
									</div>
								</div>
