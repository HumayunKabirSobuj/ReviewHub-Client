...
export default function ReviewVoting({
  reviewId,
  initialVotes,
  commentsCount = 0,
}: VotingProps) {
    ...
    <div className="flex items-center justify-between py-4 border-t border-b">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          />
          <span className={cn(userVote === "up" && "text-primary font-medium")}>
            {votes.upvotes}
          </span>
        </Button>
        <Button
        ...
        >
          <ChevronDown
            className={cn(
              "w-4 h-4 mr-1",
              userVote === "down" && "text-primary fill-primary",
            )}
          />
          <span
            className={cn(userVote === "down" && "text-primary font-medium")}
          >
            {votes.downvotes}
          </span>
        </Button>
