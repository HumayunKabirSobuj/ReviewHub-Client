...
export default function ReviewComments({ reviewId, initialComments }: ReviewCommentsProps) {
    ...
    const handleDeleteComment = async (commentId: string) => {
        try {
            ...
            toast.error("Error", {
                description: error instanceof Error ? error.message : "Failed to delete your comment. Please try again.",
            })
        }
    }
